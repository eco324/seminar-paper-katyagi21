...
#model_assist <- lm(assist ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + rural + year_factor, data = reg_data)
#summary(model_assist)
#model_register <- lm(register ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + rural + year_factor, data = reg_data)
#summary(model_register)
model_reason_t <- (lm(work_reason ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + year_factor, data = reg_data))
...
stargazer::stargazer(list(model_assist_r, model_register_r), 
