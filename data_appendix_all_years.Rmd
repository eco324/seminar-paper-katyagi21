...
model_assist <- lm(assist ~ floods + droughts + age + female + income + child + grandchild + hhhead_educ + female_hhhead + rural + year_factor, data = reg_data)
summary(model_assist)
#model_register <- lm(register ~ floods + droughts + age + female + income + child + grandchild + hhhead_educ + female_hhhead + rural + year_factor, data = reg_data)
