...
children <- subset(total_data, age < 18 & age > 4, select = c("hh_id", "age", "sex", "literacy", "dept", "urb_rur", "income", "assist", "reason", "register", "school_level", "grade", "repeated", "floods", "droughts")) 
