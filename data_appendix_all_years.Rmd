...
model_simple <- lm(assist ~ floods + droughts, data = reg_data)
summary(model_simple)
model_all <- lm(assist ~ floods + droughts + sex + age + lny + hhhead_educ + female_hhhead + urb_rur, data = reg_data)
summary(model_all)
model_register <- lm(register ~ floods + droughts + sex + age + lny + hhhead_educ + female_hhhead + urb_rur, data = reg_data)
