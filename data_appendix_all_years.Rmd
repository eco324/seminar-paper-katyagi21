...
model_assist <- lm(assist ~ floods + droughts + age + sex + income + hhhead_educ + female_hhhead + urb_rur + year, data = reg_data)
print(model_assist)
model_register <- lm(register ~ floods + droughts + age + sex + income + hhhead_educ + female_hhhead + urb_rur + year, data = reg_data)
