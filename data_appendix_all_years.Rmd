...
rural <- subset(reg_data, rural == 1, select = c("hh_id", "id", "age", "female", "literacy", "dept", "rural", "income", "assist", "register", "floods", "droughts", "year", "child", "grandchild", "num_children", "female_hhhead", "hhhead_literacy", "hhhead_educ", "year_factor"))

model_assist_r <- (lm(assist ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + year_factor, data = reg_data))
summary(model_assist_r)
model_register_r <- lm(register ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + year_factor, data = reg_data)
summary(model_register_r)
model_reason <- (lm(work_reason ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + year_factor, data = reg_data))
