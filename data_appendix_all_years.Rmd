...
total_children <- mutate(children, id = rownames(children))
...
#total <- merge(children,hh_head_2, by="hh_id")
...
#set as panel data
panel <- plm.data(reg_data, index = c("id", "year"))
model_simple <- plm(assist ~ floods + droughts, data = reg_data, model = "within")
summary(model_simple)
model_all <- plm(assist ~ floods + droughts + sex + age + lny + hhhead_educ + female_hhhead + urb_rur, data = reg_data, model = "within")
summary(model_all)
model_register <- plm(register ~ floods + droughts + sex + age + lny + hhhead_educ + female_hhhead + urb_rur, data = reg_data, model = "within")
