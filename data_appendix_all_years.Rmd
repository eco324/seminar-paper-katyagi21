...
total <- merge(total_children,hh_head_2, by="hh_id") 

total_subset <- total %>% distinct()
...
probitMod_assist <- glm(assist ~ floods + droughts + age + female + income + child + grandchild + num_children + hhhead_educ + female_hhhead + rural + year_factor, data = reg_data, family=binomial(link="probit"))  # build the logit model
