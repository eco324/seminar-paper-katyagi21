...
```{r creating line graphs for variation within variables, echo = F, message = F}
...
# Create a first line
plot(LaPaz, type = "b", frame = FALSE, pch = 19, 
     col = "red", xlab = "year", ylab = "flood counts")
# Add lines
...
legend("topleft", legend=c("LaPaz", "Potosi", "Oruro", "Beni", "Pando", "SantaCruz", "Cochabamba", "Tarija", "Chuquisaca"), col=c("red", "orange", "orangered4", "green", "yellow", "green4", "midnightblue", "mediumorchid1", "blue"), lty = 1:2, cex=0.8)
