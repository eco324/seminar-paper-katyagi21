...
```{r probit regression urban sample, echo = F, warning = F, message = F}
...
```{r probit regression total sample extr, echo = F, warning = F, message = F}
...
```{r generate probit regression table extr, echo = F, message = F, results = "asis"}
...
```{r probit regression rural sample extr, echo = F, warning = F, message = F}
