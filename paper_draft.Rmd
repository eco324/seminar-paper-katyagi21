...
reg_data <- total_subset %>%
  mutate(year_factor = as.factor(year),
         ...
         lny = log(income + 1),
         valley = case_when(dept %in% c("Chuquisaca", "Cochahamba", "Tarija") ~ 1, TRUE ~ 0),
         mountain = case_when(dept %in% c("La Paz", "Oruro", "Potosi") ~ 1, TRUE ~ 0),
...
Work_reason     & Binary variable, 1 = does not attend school for work reasons \\
